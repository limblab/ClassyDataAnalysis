function [still,stats]=isStill(cds,x,varargin)
    %isStill is a method of the cds class and should be saved in the @cds
    %folder with the other methods. isStill is not intended to be a user
    %accessible function
